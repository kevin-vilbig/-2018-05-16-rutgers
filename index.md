...
venue: "Rutgers University Data Skills Boot Camp"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Dana Library Electronic Classroom #1, 185 University Avenue, Newark, NJ 07102"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["Kevin Vilbig", "Vinh Pham"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Stephanie Mikitish", "Huan Wang", "Keyi Zhao"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman""
email: ["blf34@libraries.rutgers.edu", "kevin@fu9ar.com", "phamngocvinh@utexas.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
